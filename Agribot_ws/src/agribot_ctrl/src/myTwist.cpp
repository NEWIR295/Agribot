...
int main(int argc, char** argv){
  ros::init(argc, argv, "AgribotTwist");
  ros::NodeHandle n;
  ...
  while(ros::ok()){
    ...
    currentTwist = agriBot.cmdVel(currentWheelAngVelocity.data[0],currentWheelAngVelocity.data[1],wheel_radius,wheel_separation);   
    /* Update the twist */    
