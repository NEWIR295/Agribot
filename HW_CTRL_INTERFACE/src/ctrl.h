...
#define pinDirLeft2 8 // dir left motor = Pin 8
#define pinPwmLeft2 9 // PWM left motor = Pin 9
//motor driver right side
#define pinDirRight1 10 // dir right motor = Pin 10
#define pinPwmRight1 11 // PWM right motor = Pin 11
#define pinDirRight2 10 // dir right motor = Pin 10
#define pinPwmRight2 11 // PWM right motor = Pin 11
